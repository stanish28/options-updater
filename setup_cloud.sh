...
echo -e "Select your editor and paste the following line at the bottom to run at 6:00 AM + 12:00 PM PT:"
echo -e "  ${YELLOW}0 6,12 * * 1-5 cd $(pwd) && ./sync >> launchd.log 2>&1${NC}"
echo -e "${BLUE}-------------------------------------------------------------${NC}"
